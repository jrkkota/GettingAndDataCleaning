...
Implementation of run_analysis.R based on the transformation details above:

Checks for the data.table and the reshape2 libraries.
1.  Loads both the test and train data sets from the test and train directories
